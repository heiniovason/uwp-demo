...
using BookitLoginUWP.Activation;
using BookitLoginUWP.BackgroundTasks;
using BookitLoginUWP.Core.Helpers;

using Windows.ApplicationModel.Activation;
using Windows.ApplicationModel.Background;

namespace BookitLoginUWP.Services
{
    internal class BackgroundTaskService : ActivationHandler<BackgroundActivatedEventArgs>
    {
        ...
        private static IEnumerable<BackgroundTask> CreateInstances()
        {
            ...
            backgroundTasks.Add(new FailedLoginAttempts());
            backgroundTasks.Add(new UpdateBookingSchedule());
            backgroundTasks.Add(new WorkstationBookingStatus());
